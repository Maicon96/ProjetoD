...
public class LayoutArquivoDelimitacaoId implements Serializable {
	...
	public LayoutArquivoDelimitacaoId() {
		
	}

	public LayoutArquivoDelimitacaoId(Long id, Long idLayoutArquivo, Long idLayout) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LayoutArquivoDelimitacaoId other = (LayoutArquivoDelimitacaoId) obj;
		if (id == null) {
			if (other.id != null)
				return false;
